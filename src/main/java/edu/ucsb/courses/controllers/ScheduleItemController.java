...
//     public ResponseEntity<String> createScheduleItem(@RequestHeader("Authorization") String authorization,
//                                                   @RequestBody @Valid String scheduleItem
//                                                  ) throws JsonProcessingException {
//         if(!authControllerAdvice.getIsMember(authorization)){
//             return new ResponseEntity<>("Unauthorized Request", HttpStatus.UNAUTHORIZED);
//         }
//         JSONObject si = new JSONObject(scheduleItem);
//         AppUser appUser = authControllerAdvice.getUser(authorization);
//         ScheduleItem newSched = new ScheduleItem(null, lectureCode, discussionCode, appUser, schedule);
...
//                                                       @RequestParam Schedule id) throws JsonProcessingException {
//         AppUser appUser = authControllerAdvice.getUser(authorization);
//         if(!authControllerAdvice.getIsMember(authorization)){
//             return new ResponseEntity<>("Unauthorized Request", HttpStatus.UNAUTHORIZED);
//         }
