...
const Schedule = () => {
  ...
  return (
    <Jumbotron>
      ...
      <h1>Load Schedule</h1>
      <ScheduleSearchForm deleteSchedule={fetchdeleteScheduleJSON} getSchedule={fetchgetScheduleJSON} getToken={getToken}
         onSuccess={(json) => setScheduleJSON(json)} onError={(error) => console.log(error)} />
      <Form.Group> </Form.Group>
      <Form.Group> </Form.Group>
