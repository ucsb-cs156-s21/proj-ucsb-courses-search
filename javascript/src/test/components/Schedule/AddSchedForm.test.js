...
describe('AddSchedForm tests', () => {
  ...
  test('when I click submit without selecting quarter, quarter is set to its default value', async () => {
  ...
  test('when I choose a quarter, the state for quarter changes', () => {
    ...
    userEvent.selectOptions(schedQuarter, '20084');
    expect(schedQuarter.value).toBe('20084');
  });
